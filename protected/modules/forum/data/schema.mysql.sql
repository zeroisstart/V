...
CREATE TABLE `post` (
	...
	CONSTRAINT `FK_post_author_KEY` FOREIGN KEY (`author_id`) REFERENCES `forumuser` (`id`) ON DELETE CASCADE,
	CONSTRAINT `FK_post_editor_KEY` FOREIGN KEY (`editor_id`) REFERENCES `forumuser` (`id`) ON DELETE CASCADE,
	CONSTRAINT `FK_post_thread_KEY` FOREIGN KEY (`thread_id`) REFERENCES `thread` (`id`) ON DELETE CASCADE
)
COLLATE='utf8_general_ci'
ENGINE=InnoDB;
