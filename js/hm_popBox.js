...
(function(exports){
    ...
    getConfirmTpl=function(txt,ok,cc){
        var ctpl='<div class="NY-con-cofirm"><div class="NY-con-cnfirm-txt"><div class="NY-con_icon icon NY-warn"></div><div class="NY-ccf"><p>'+txt+'</p></div></div><div class="NY-com-btnarea"><a href="#" class="NY_rt_btn NY_rt_active" node-type="ok"><b class="NY_iw"><b class="NY_ii"><u class="NY_it">'+ok+'</u></b></b></a><a href="#" class="NY_rt_btn" node-type="cancel"><b class="NY_iw"><b class="NY_ii"><u class="NY_it">'+cc+'</u></b></b></a></div></div>';
        return ctpl;
    },
