...
(function(exports){
	...
	getPopTpl=function(ntitle,title,arrow){
		var popTpl='<div class="NY-pop-warp">'+(arrow?'<div class="NY-arrow"><span class="npa-a npa-w">◆</span><span class="npa-a npa-u">◆</span><span class="npa-a npa-b">◆</span></div>':'')+'<div class="NY-pop-bg"><div class="NY-pop-ct">'+(ntitle?'':'<div class="NY-pop-title"><a href="javascript:;" class="nyt-close"></a><h4 class="nyt-txt">'+title+'</h4></div>')+'<div class="NY-con-warp" note-type="pop-cont-warp"></div></div></div></div>';
		return popTpl;
	},
	...
	mask.prototype={
		...
		create:function(){
			var __=this;
			html='<div class="NY-pop-mask"></div>';
			var mobj=$(html);
			__.setattr(mobj);
			$body.append(mobj);
			__.mobj=mobj;
	...
	popFn.prototype={
		...
		createpop:function(){
			var __=this;
			var html=getPopTpl(__.noTitle,__.title,__.arrow);
			var pobj=$(html);
			$body.append(pobj);
			__.setZindex(pobj);
			__.setPostion(pobj);
